...
export GST_PLUGIN_PATH_1_0="${VOICEPRINT_ROOT}/.runtime/gstreamer/plugins${GST_PLUGIN_PATH_1_0:+:${GST_PLUGIN_PATH_1_0}}"
export LD_LIBRARY_PATH="${VOICEPRINT_ROOT}/.runtime/gstreamer/lib${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"
